...
$id_usuario = id_usuario(); // Assumindo que você tem uma função similar ao id_usuario()
...
// Simulação de necessidades (você pode adaptar com lógica real)
foreach ($plantas_jardim as $planta) {
    // Lógica simulada - você pode implementar lógica real baseada em datas, etc.
...
<section class="py-12 bg-white dark:bg-gray-900 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-green-50 dark:bg-gray-800 rounded-2xl p-6 text-center">
            ...
            <div class="bg-green-50 dark:bg-gray-800 rounded-2xl p-6 text-center">
                <div class="text-2xl font-bold text-green-600 dark:text-green-400 mb-2"><?= $precisam_rega ?></div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Precisam de Rega</div>
            </div>
            <div class="bg-green-50 dark:bg-gray-800 rounded-2xl p-6 text-center">
                <div class="text-2xl font-bold text-green-600 dark:text-green-400 mb-2"><?= $precisam_adubo ?></div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Precisa de Adubo</div>
            </div>
            <div class="bg-green-50 dark:bg-gray-800 rounded-2xl p-6 text-center">
                <div class="text-2xl font-bold text-green-600 dark:text-green-400 mb-2"><?= $proximas_poda ?></div>
        ...
        <div class="flex flex-wrap gap-4 mb-8">
            <button class="px-4 py-2 bg-green-600 text-white rounded-full hover:bg-green-700 transition font-medium">
                Todas as Plantas
            </button>
            <button class="px-4 py-2 bg-green-100 dark:bg-gray-700 text-green-800 dark:text-green-300 rounded-full hover:bg-green-200 dark:hover:bg-gray-600 transition font-medium">
                Precisam de Rega
            </button>
            <button class="px-4 py-2 bg-green-100 dark:bg-gray-700 text-green-800 dark:text-green-300 rounded-full hover:bg-green-200 dark:hover:bg-gray-600 transition font-medium">
                Precisa de Adubo
        ...
        <?php if ($total_plantas > 0): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <!-- Planta do Jardim -->
                <div class="bg-green-50 dark:bg-gray-800 rounded-2xl overflow-hidden hover:scale-105 transition cursor-pointer border-2 <?= $cor_borda ?>">
                    <div class="relative">
                        ...
                        <?php endif; ?>
                        <div class="absolute top-3 right-3 <?= $badge_cor ?> text-white px-2 py-1 rounded-full text-xs font-medium">
                            <?= $badge_texto ?>
                        </div>
                    </div>
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex gap-2">
                                <a href="../plants/plants-profile.php?id=<?= $planta['id'] ?>" class="bg-green-600 text-white px-3 py-1 rounded-full text-sm hover:bg-green-700 transition">
                                    Cuidar
                                </a>
                                <a href="delete-plant-garden.php?id=<?= $planta['jardim_id'] ?>" 
                                   class="bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full text-sm hover:bg-gray-400 dark:hover:bg-gray-500 transition"
                                   onclick="return confirm('Tem certeza que deseja remover esta planta do seu jardim?')">
                                    Remover
                                </a>
                            </div>
                        </div>
        ...
        <?php else: ?>
            <!-- Jardim Vazio -->
            <div id="emptyGarden" class="text-center py-12">
                <div class="bg-green-50 dark:bg-gray-800 rounded-2xl p-12">
                    ...
                    <a href="../garden/my-garden.php" class="px-6 py-3 bg-green-600 text-white rounded-full hover:bg-green-700 transition font-medium">
                        Explorar Plantas
                    </a>
                </div>
            </div>
