        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="bg-green-600 px-6 py-8">
                <div class="flex items-center space-x-6">
                    <img src="<?= foto_usuario(); ?>" alt="Foto de perfil" class="w-24 h-24 bg-white rounded-full object-cover">
                    <div>
...
<div id="modalExcluir" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
    <div class="bg-white rounded-2xl p-8 max-w-md w-full mx-4">
        <h2 class="text-2xl font-bold text-red-600 mb-4">⚠️ Excluir Conta</h2>
        ...
        <form action="delete-user.php" method="POST">
            ...
            <div class="flex gap-4">
                <button type="submit" 
                        class="flex-1 px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-medium">
                    Confirmar Exclusão
                </button>
                <button type="button" 
                        onclick="fecharModalExcluir()"
                        class="flex-1 px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition font-medium">
                    Cancelar
                </button>
            </div>
        </form>
